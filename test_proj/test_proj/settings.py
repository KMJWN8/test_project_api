...
SECRET_KEY = "django-insecure-oy*1%okr!tuvnv3d2f5(_&jivqwyxshf!2fbdd7es$s@p#pmp="
...
MEDIA_ROOT = os.path.join(BASE_DIR, "media")  # Путь к папке для хранения медиафайлов
